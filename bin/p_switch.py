#!/usr/bin/env python
"""
Makes the initial preperation of json dictionary and switch/moves the hostname to a particular set depending on the request i.e FROM/TO batch/cloud
...
Assume: State of hostnames is defined in a given json file and file conataining the list of hostnames to switch are provided in the CWD
Take: Json dictionary from json file and file conataining the list of hostnames to switch in CWD
Does: Makes the initial preperation of json dictionary and switch/moves the hostname to a particular set depending on the request i.e FROM/TO batch/cloud         
...
if have_args:
    ...
    if opt == 'to_cloud':
        ...
        try:
            ...
            B2CR = set()
        """Firstly B2CR should not include the hostname which are already in list C and Secondly it should contain unique elements from present and past requests"""
        ...
        try:
            ...
            C2BR = set()
        """Firstly C2BR should not include the hostname which are already in list B and Secondly it should contain unique elements from present and past requests"""
