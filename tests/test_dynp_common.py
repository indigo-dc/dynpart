...
class TestNow(unittest.TestCase):
    ...
    def test_mlog(self):
        ...
        self.assertEqual(f.read(), "%s %s:" % (now(), script_name) + 'Please check the path of the file' + '\n')
    ...
    def test_put_jsondict(self):
        ...
        self.assertTrue(mydict_2.has_key('Alpha'))
        self.assertFalse(mydict_2.has_key('blah'))
